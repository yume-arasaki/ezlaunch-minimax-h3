...
| DGX Spark (GB10) | `dgx_spark` | MEASURED (ours): 10s @ 720p, 20-step, ~20 min via **drowzeys Sol-Engine (primary)**. MEASURED (drowzeys): 5s @ 864×480 full stack 202.5s (1.54×); 15s/362f ~32 min. MEASURED (chishiki37): 15.08s @ 384×672 AV base. | SM121-specific (sage<3.0, no `--use-sage-attention`) — see `docs/DGX-SPARK.md` |
