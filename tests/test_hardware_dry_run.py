...
CARDS = [
    # name, vram_mib, driver, expect_profile, evidence
    ...
    ("NVIDIA GeForce RTX 3080", 10240, "550.54", "nvidia_12gb", "SPEC Hamster 10-12GB row"),
    ...
    ("NVIDIA GeForce RTX 4070", 12282, "560.70", "nvidia_12gb", "SPEC Hamster 10-12GB row"),
    ...
    ("NVIDIA GeForce RTX 5060", 8188, "576.02", "nvidia_8gb", "MEASURED 5060 8GB 5-6min / Hamster"),
    ("NVIDIA GeForce RTX 5060 Ti", 16384, "576.02", "nvidia_16gb", "MEASURED 5060 Ti 16GB runs 1344x768, OOM at native 1080p / Jarvis"),
    ("NVIDIA GeForce RTX 5070", 12288, "576.02", "nvidia_12gb", "SPEC Hamster 10-12GB row"),
    ("NVIDIA GeForce RTX 5070 Ti", 16384, "576.02", "nvidia_16gb", "REPORTED UdonJP ~14.2–14.4 GiB peak"),
    ("NVIDIA GeForce RTX 5080", 16384, "576.02", "nvidia_16gb", "REPORTED 10s@480p ~3min / Hamster"),
