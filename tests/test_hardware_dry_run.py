...
CARDS = [
    ...
    ("NVIDIA GeForce RTX 2080 Ti", 11016, "550.54", "nvidia_12gb", "SPEC 11GB Turing → 10-12GB tier"),
    ...
    ("NVIDIA GeForce RTX 5060", 8188, "576.02", "nvidia_8gb", "MEASURED 5060 Laptop 8GB runs 15s@480p/10s@960x544/5s~720p (Tensor Alchemist)"),
